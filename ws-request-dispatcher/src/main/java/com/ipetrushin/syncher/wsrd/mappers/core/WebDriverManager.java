package com.ipetrushin.syncher.wsrd.mappers.core;
...
public abstract class WebDriverManager implements Runnable {
    ...
    private SyncherMessage exchange;
    ...
    public SyncherMessage getExchange() {
        return exchange;
    }

    public void setExchange(SyncherMessage exchange) {
    ...
    public void processRequest(SyncherMessage exchange) {
        try {
